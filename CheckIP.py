...
class requestHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if ctype =='multipart/form-data':
            ...
            ip = cmd_result[cmd_result.find("[")+1 : cmd_result.find("]")-1]
